...
use bitcoin::opcodes::all::{
    OP_2DUP, OP_CAT, OP_CHECKSIG, OP_CHECKSIGVERIFY, OP_CSV, OP_DROP, OP_DUP, OP_EQUALVERIFY,
    OP_FROMALTSTACK, OP_HASH256, OP_NOP4, OP_ROT, OP_SHA256, OP_SWAP, OP_TOALTSTACK,
};
